...
public class Btn_carga : MonoBehaviour {

	public event Action<Btn_carga> OnButtonSelected;  
	...
	void cambiar_textura (){ 
		Debug.Log ("nombre del button "+ gameObject.name);

		// metodo de cambio de textura o hambiente
		Manegador_imagen.instancia.cambiar_textura (index );

		Contenedor_de_escenarios.instancia.Actualizador_escenarios (index);


		gameObject.SetActive (true);
		// activar   o desactivar  hotspot
