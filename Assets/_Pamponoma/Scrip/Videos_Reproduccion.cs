...
public class Videos_Reproduccion : MonoBehaviour {
	public event Action<Videos_Reproduccion> OnButtonSelected;  
	public Inicio_animacion inicio_animacion;
		...
		Manegador_videos.istancia.play_video ();
		inicio_animacion.inicar_viaje_videos ();
